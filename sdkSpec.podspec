...
TODO: Add long description of the pod here.
  ...
  s.homepage         = 'https://gitee.com/xylove/sdk'
  # s.screenshots     = 'www.example.com/screenshots_1', 'www.example.com/screenshots_2'
  s.license          = { :type => 'MIT', :file => 'LICENSE' }
  s.author           = { 'Xiaoyuting' => '479072483@qq.com' }
  s.source           = { :git => 'https://gitee.com/xylove/sdk.git', :tag => s.version.to_s }
  ...
  s.vendored_frameworks = ['sdkSpec/DataConfigSDK.xcframework'] #自己的framework在工程中的路径
